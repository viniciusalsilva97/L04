...
#INCLUDE 'topconn.ch'
#INCLUDE 'tbiconn.ch'
//* Deixei alguns comentários de rascunho para questões de estudo futuro. Fiz isso nesse e em alguns outros exercícios.
// SET CENTURY ON 
// SET DATE BRITISH
// SET (_SET_EPOCH, 1980) colocar após as declarações de variável
